<?php
/**
 * Script de diagnostic simple - à exécuter directement sur le serveur
 * URL: https://iot.olution.info/ffp3/public/diagnostic-simple-direct.php
 */
...
echo "<h1>🔍 Diagnostic Simple Direct - " . date('Y-m-d H:i:s') . "</h1>";
