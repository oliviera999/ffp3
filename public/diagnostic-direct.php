<?php
/**
 * Script de diagnostic direct - accessible via fichier PHP
 * URL: https://iot.olution.info/ffp3/public/diagnostic-direct.php
 */
...
echo "<h1>🔍 Diagnostic Direct FFP3 - " . date('Y-m-d H:i:s') . "</h1>";
