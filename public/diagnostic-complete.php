<?php
/**
 * Script de diagnostic complet - contourne Slim
 * URL: https://iot.olution.info/ffp3/public/diagnostic-complete.php
 */
...
echo "<h1>🔍 Diagnostic Complet FFP3 - " . date('Y-m-d H:i:s') . "</h1>";
...
try {
    ...
    echo "<h2>8. Test des middlewares</h2>";
    ...
    try {
        ...
        // Vérifier le middleware d'environnement
        $envMiddleware = new \App\Middleware\EnvironmentMiddleware('prod');
        echo "✅ EnvironmentMiddleware créé<br>";
        
    } catch (\Throwable $e) {
        echo "❌ Erreur middlewares: " . $e->getMessage() . "<br>";
        echo "Fichier: " . $e->getFile() . " ligne " . $e->getLine() . "<br>";
    }
