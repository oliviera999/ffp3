...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($api_key == $api_key_value) {
        ...
        UPDATE ffp3Outputs SET state = '" . $etatPompeAqua . "' WHERE gpio = 16 AND board = 1;
        UPDATE ffp3Outputs SET state = '" . $etatPompeTank . "' WHERE gpio = 18 AND board = 1;
        UPDATE ffp3Outputs SET state = '" . $etatHeat . "' WHERE gpio = 2 AND board = 1;
        UPDATE ffp3Outputs SET state = '" . $etatUV . "' WHERE gpio = 15 AND board = 1;
        UPDATE ffp3Outputs SET state = '" . $bouffePetits . "' WHERE gpio = 108 AND board = 1;
        UPDATE ffp3Outputs SET state = '" . $bouffeGros . "' WHERE gpio = 109 AND board = 1;
        UPDATE ffp3Outputs SET state = '" . $resetMode . "' WHERE gpio = 110 AND board = 1;
        UPDATE ffp3Outputs SET state = '" . $mail . "' WHERE gpio = 100 AND board = 1;
        UPDATE ffp3Outputs SET state = '" . $mailNotif . "' WHERE gpio = 101 AND board = 1;
        UPDATE ffp3Outputs SET state = '" . $aqThreshold . "' WHERE gpio = 102 AND board = 1;
        UPDATE ffp3Outputs SET state = '" . $tankThreshold . "' WHERE gpio = 103 AND board = 1;
        UPDATE ffp3Outputs SET state = '" . $chauffageThreshold . "' WHERE gpio = 104 AND board = 1;
        UPDATE ffp3Outputs SET state = '" . $bouffeMat . "' WHERE gpio = 105 AND board = 1;
        UPDATE ffp3Outputs SET state = '" . $bouffeMidi . "' WHERE gpio = 106 AND board = 1;
