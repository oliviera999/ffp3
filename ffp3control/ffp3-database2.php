...
$password = "Iot#Olution1";
    ...
    function createOutput($mail, $mailNotif, $aqThr, $taThr, $tempsRemplissageSec, $limFlood, $chauff, $bouffeMat, $bouffeMid, $bouffeSoir, $tempsGros, $tempsPetits, $WakeUp, $FreqWakeUp) {
        ...
        $sql = "UPDATE ffp3Outputs2 SET state = '" . $mail . "' WHERE gpio = 100 AND board = 1;
        UPDATE ffp3Outputs2 SET state = '" . $mailNotif . "' WHERE gpio = 101 AND board = 1;
        UPDATE ffp3Outputs2 SET state = '" . $aqThr . "' WHERE gpio = 102 AND board = 1;
        UPDATE ffp3Outputs2 SET state = '" . $taThr . "' WHERE gpio = 103 AND board = 1;
        ...
        UPDATE ffp3Outputs2 SET state = '" . $chauff . "' WHERE gpio = 104 AND board = 1;
        UPDATE ffp3Outputs2 SET state = '" . $bouffeMat . "' WHERE gpio = 105 AND board = 1;
        UPDATE ffp3Outputs2 SET state = '" . $bouffeMid . "' WHERE gpio = 106 AND board = 1;
